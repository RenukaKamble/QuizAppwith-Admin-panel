var questions = [
    {
        question: "Which force done by the system will increase the potential energy of the system?",
    ...
    {
        question: "Who invented the microwave?",
...
function appendResult() {
    ...
    for (var i = 0; i < questions.length; i++) {
        if (answers[i]) {
            divBody += "<td><img style='width:30px' src='accept.jpeg'></td>"
            correctQuestions++
        }
        else divBody += "<td><img style='width:30px' src='close.jpg'></td>"
    }
    divBody += "</tbody></table>"
...
function loginButton() {
    ...
    if (username.value === "Renuka" && password.value === "renu@123") {
